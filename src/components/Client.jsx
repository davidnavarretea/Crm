  ...
  return (
    <tr className="border-b shadow-lg border-blue-900 hover:bg-gray-50">
        ...
        <td className="p-3 text-center text-gray-800 font-semibold">
            ...
            <button type="button" className="bg-blue-900 hover:bg-blue-800 text-white block w-full p-2 uppercase font-bold text-xs">Edit</button>
            <button type="button" className="bg-red-900 hover:bg-red-800 text-white block w-full p-2 uppercase font-bold text-xs">Delete</button>
        </td>
    </tr>
  )
}
